...
使い方: python smoke_test.py [BASE_URL] [API_KEY]
  既定: http://localhost:8000/mcp / localtestkey
"""
import asyncio
import sys
...
if __name__ == "__main__":
    ...
    api_key = sys.argv[2] if len(sys.argv) > 2 else "localtestkey"
    asyncio.run(main(base, api_key))
